        ...
        <div className="grid md:grid-cols-3 gap-10">
            <div className='pb-[50px] px-[30px] rounded-md'>
                ...
                <div className="text-center mt-4">
                    <h3 className='text-[18px] leading-[30px] text-headingColor font-bold'>Dr. Lalu Yadav</h3>
                ...
                <div className='mt-[50px] md:mt-[100px] text-white'>
                    <button onClick={handleLogout} className='w-full bg-[#181A1E] p-3 text-[16px] leading-7 rounded-md '>Logout</button>
